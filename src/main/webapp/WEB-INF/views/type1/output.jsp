		...
		<div class="container mt-5">
			<table class="table table-bordered">
				...
				<tr>
					...
					<td class="col-7"><fmt:formatNumber type="currency" value="${type1Form.pocketMoney}" currencySymbol="¥" maxFractionDigits="0"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="col-7">${type1Form.newsletter}</td>
				</tr>
				<tr>
					<th class="col-3">性別</th>
					<td class="col-7">${type1Form.gender}</td>
				</tr>
				<tr>
					<th class="col-3">生年月日</th>
					<td class="col-7"><fmt:formatDate value="${type1Form.birthdate}" pattern="yyyy年MM月dd日"/></td>
				</tr>
				<tr>
					<th class="col-3">都道府県</th>
					<td class="col-7">${type1Form.prefecture}</td>
				</tr>
				<tr>
